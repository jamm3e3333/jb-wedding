import CoverWithImage, {ImageGradientInterface} from "./components/ui/cover-with-image";
...
function App() {
  ...
  return (
    <>
      <CoverWithImage  image={{ src: COVER_IMAGE_FILE_PATH, linearGradient: imageGradient }}>
        <LandingAnnouncement />
      </CoverWithImage>
      <Reception/>
    </>
